  ...
  */
  class Datatables
  {
    ...
    */
    ...
    public function set_url($set_url) {
      $this->set_url = $set_url;
      return $this;
    }

    public function set_data($set_data) {
      $this->set_data = $set_data;
      return $this;
    }

    public function set_selector($set_selector) {
      $this->set_selector = $set_selector;
      return $this;
    }

    public function create() {
      $data['url'] = $this->set_url;
      $data['data'] = $this->set_data;
      $data['selector'] = $this->set_selector;
      return get_instance()->load->view('datatables', $data, true);
    }
  }
