...
table = $('#table_kategori').DataTable({
    'ajax': {
        'url': '<?= base_url('data_perpus/kategori_fetch') ?>',
        'dataSrc': 'data',
        'type': 'POST'
    },
    'processing': true,
...
function edit(id) {
    ...
    $.ajax({
        url: "<?= base_url("data_perpus/kategori_edit/") ?>" + id,
        dataType: "html",
        success: function(result) {
            $.LoadingOverlay("hide");
...
function hapus(id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.post('<?= base_url('data_perpus/kategori_hapus') ?>', {
                'id': id
...
function detail(id) {
    $.LoadingOverlay("show");
    $.ajax({
        url: "<?= base_url("data_perpus/kategori_detail/") ?>" + id,
        dataType: "html",
        success: function(result) {
            $.LoadingOverlay("hide");
            $('#infouser').modal('show');
            ...
            <form id="form_tambah" action="<?= base_url('data_perpus/kategori_simpan'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kategori_keterangan" id="kategori_keterangan"
                            required="">
                    </div>
                </div>
