        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                <button onclick="tambah();" class="btn btn-icon icon-left btn-primary" data-toggle="modal"
                    data-target="#tambah_buku_mata_kuliah">
...
var table = $('table').DataTable({
    'ajax': {
        'url': '<?php echo base_url("administrator/buku_mata_kuliah_fetch") ?>',
        'dataSrc': 'data',
        'type': 'POST'
    },
    'processing': true,
...
function saveData() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $('#tambah_buku_mata_kuliah').modal('hide');
            $('input').val('');
...
function tambah() {
    ...
    $('#tambah_buku_mata_kuliah').modal('show');
    $.LoadingOverlay("hide");
}
...
<!-- modal tambah -->
<div class="modal fade" tabindex="-1" role="dialog" id="tambah_buku_mata_kuliah" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_tambah" action="<?= base_url('administrator/buku_mata_kuliah_simpan'); ?>" method="post">
