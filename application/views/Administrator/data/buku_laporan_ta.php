...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Buku Laporan Tugas Akhir</h1>
        </div>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                <button onclick="tambah();" class="btn btn-icon icon-left btn-primary" data-toggle="modal"
                    data-target="#tambah_buku_laporan_ta">
...
var table = $('table').DataTable({
    'ajax': {
        'url': '<?php echo base_url("administrator/buku_laporan_ta_fetch") ?>',
        'dataSrc': 'data',
        'type': 'POST'
    },
    'processing': true,
...
function saveData() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $('#tambah_buku_laporan_ta').modal('hide');
            $('input').val('');
...
function tambah() {
    ...
    $('#tambah_buku_laporan_ta').modal('show');
    $.LoadingOverlay("hide");
}
...
<div class="modal" id="infouser" role="dialog" data-backdrop="false" style="background: rgba(0,0,0,0.3);">
    <div class="modal-dialog modal-lg">
        <div class="modal-content P-1">
            ...
            <form id="form_detail" action="<?= base_url('administrator/buku_refrensi_detail'); ?>" method="post">
...
<div class="modal fade" tabindex="-1" role="dialog" id="update_buku" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_update" action="<?= base_url('administrator/buku_update'); ?>" method="post">
...
<!-- modal tambah -->
<div class="modal fade" tabindex="-1" role="dialog" id="tambah_buku_laporan_ta" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form_tambah" action="<?= base_url('administrator/buku_laporan_ta_simpan'); ?>" method="post">
