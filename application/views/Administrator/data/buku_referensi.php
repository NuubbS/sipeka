        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                <button onclick="tambah();" class="btn btn-icon icon-left btn-primary" data-toggle="modal"
                    data-target="#tambah_buku_referensi">
...
var table = $('table').DataTable({
    'ajax': {
        'url': '<?php echo base_url("administrator/buku_referensi_fetch") ?>',
        'dataSrc': 'data',
        'type': 'POST'
    },
    'processing': true,
...
<div class="modal fade" tabindex="-1" role="dialog" id="update_buku" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_update" action="<?= base_url('administrator/buku_referensi_update'); ?>" method="post">
...
<div class="modal fade" tabindex="-1" role="dialog" id="tambah_buku_referensi" aria-hidden="true"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Masukkan Data bukua</h5> <button type="button" class="close"
                    data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
            </div>
            <form id="form_tambah" action="<?= base_url('administrator/buku_referensi_simpan'); ?>" method="post">
