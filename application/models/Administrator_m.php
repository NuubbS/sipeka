...
class administrator_m extends CI_Model
{
    ...
    public function update_anggota($user_id, $data)
    {
        if (@$this->db->where('user_id', $user_id)->update('tb_user', $data)) {
            return true;
        } else {
            return false;
        }
    ...
    public function update_petugas($user_id, $data)
    {
        if (@$this->db->where('user_id', $user_id)->update('tb_user', $data)) {
            return true;
        } else {
    ...
    {
        if (@$this->db->where('user_id', $id)->delete("tb_user")) {
            return true;
        } else {
            return false;
        }
